...
class AuditBuilder(object):
    """AuditBuilder class takes a filename
    and data and builds the auditbook
    from the given data.
    """

    def __init__(self, filename, start_date, end_date, data_generator, **flags):
    ...
    def _build_auditbook(self):
        ...
        @return: None
        """
        for data in self._data_generator:
