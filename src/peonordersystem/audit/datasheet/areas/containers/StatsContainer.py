...
from src.peonordersystem.audit.datasheet.areas.parsers.DataParserFactory \
    import DataParserFactory

from src.peonordersystem.audit.datasheet.areas.parsers.components.KeyParsers \
    import DateKeyParser


class TimeCategoryStatsContainer(Container):
    """Container used for interacting with
    stats components that operate based
    on category.
    """
    ...
    def __init__(self, attributes, time_keys):
        ...
        expected value parser and stats components type.
