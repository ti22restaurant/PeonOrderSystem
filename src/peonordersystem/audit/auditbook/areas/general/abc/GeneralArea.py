...
class GeneralArea(Area):
    """Abstract Base Class.

    GeneralArea class represents the abstract
    ...
    def __init__(self):
        """Initializes a new GeneralArea class
        """
    ...
    def connect(self, worksheet):
        ...
        GeneralArea. The worksheet will
    ...
    def _set_worksheet_row(self, row=-1, height=None, format=None):
        ...
        self._check_worksheet_write_data()
        self._worksheet.set_row(row, height, format=format)
    ...
    def _set_worksheet_column(self, first_col=-1, last_col=-1, width=None,
        ...
        if not width:
            width = self.AREA_COL_WIDTH
        self._check_worksheet_write_data()
        self._worksheet.set_column(first_col, last_col, width, format=format)
