...
class UI(object):
    ...
    def __init__(self, title):
        ...
        Orders and Reservations objects
    ...
    def menu_button_clicked(self, widget):
        ...
        @param widget: MenuButton object that stores a MenuItem
        as widget.MenuItem.
        """
    ...
    def edit_note(self, *args):  # @IGNORE:W0613
        ...
        clicked. This method instatiates a new dialog window
        which the user preforms the desired actions on. Upon
        closing the window is the deleted.
        
        @param *args: wildcard representing the button clicked.
        """
        menu_item = self.orders.get_selected()
        print "notes before: " + menu_item.notes
        self.editor.edit_note(menu_item)
        print "notes after: " + menu_item.notes
        self.orders.update()
    ...
    def order_confirmed(self, *args):
        ...
        @param args: wildcard parameter represented by  
        """
        pass
